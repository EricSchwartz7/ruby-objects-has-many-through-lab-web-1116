...
describe "Patient" do
  ...
  describe "#add_appointment" do
    it "takes in an argument of an apppointment and adds that appointment to its list of appointments and tells that appointment it belongs to the patient" do 
